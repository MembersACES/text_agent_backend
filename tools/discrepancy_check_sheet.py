...
HEADER_TO_KEY_GAS = {
    ...
    "contract mdq overrun": "contract_mdq_overrun",
    "contract mdq overrun found": "contract_mdq_overrun_found",
    "contract mdq overrun quantity": "contract_mdq_overrun_quantity",
    "contract mdq overrun rate": "contract_mdq_overrun_rate",
    "contract mdq overrun charge": "contract_mdq_overrun_charge",
    "agreementyear": "agreement_year",
    "agreement year": "agreement_year",
    "mqa gj": "maq_gj",
    "maq gj": "maq_gj",
    "cpq gj": "cpq_gj",
    "invoices counted": "invoices_counted",
    "consumption to date": "consumption_to_date_gj",
    "consumption to date gj": "consumption_to_date_gj",
    "data through": "data_through",
    "days elapsed": "days_elapsed",
    "agreement year days": "agreement_year_days",
    "% year elapsed": "pct_year_elapsed",
    "% maq consumped": "pct_maq_consumed", 
    "% maq consumed": "pct_maq_consumed",
    "pace": "pace",
    "projected annual gj": "projected_annual_gj",
    "projects vs maq": "projected_vs_maq_gj",
    "projected vs maq": "projected_vs_maq_gj",
    "risk band": "risk_band",
}
