...
def create_offer_activity(
    ...
    *,
    ...
    ACTIVITY_TO_STAGE = {
        ...
        OfferActivityType.ALINTA_AGREEMENT_REQUESTED: OfferPipelineStage.CONTRACT_REQUESTED,
...
ACTIVITY_TYPES_FOR_STRATEGY = {
    ...
    OfferActivityType.NEW_REVENUE_INVOICE,
    OfferActivityType.SOLUTION_PRESENTATION,
    OfferActivityType.ENGAGEMENT_FORM_SIGNED,
    OfferActivityType.CONTRACT_SIGNED_LODGED,
    OfferActivityType.CONTRACT_REQUESTED,
    OfferActivityType.ALINTA_AGREEMENT_REQUESTED,
...
ACTIVITY_TYPE_LABELS = {
    ...
    OfferActivityType.NEW_REVENUE_INVOICE: "Discrepancy / New Revenue invoice",
    ...
    OfferActivityType.ALINTA_AGREEMENT_REQUESTED: "Alinta agreement requested",
